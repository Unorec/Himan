                    ...
                    <form id="settingsForm">
                        ...
                        <div class="settings-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <label>結束時間</label>
                                    <input type="time" name="specialEnd" value="${settings.specialTimeSlot.end}">
                                </div>
                                <div class="form-group">
                                    <label>折扣百分比</label>
                                    <input type="number" name="discount" value="${settings.specialTimeSlot.discount}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="settings-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label>一般票價</label>
                                    <input type="number" name="regularPrice" value="${settings.prices.regular}">
                                </div>
                                <div class="form-group">
                                    <label>學生票價</label>
                                    <input type="number" name="studentPrice" value="${settings.prices.student}">
                                </div>
                                <div class="form-group">
                                    <label>敬老票價</label>
                                    <input type="number" name="seniorPrice" value="${settings.prices.senior}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="settings-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label>櫃位數量</label>
                                    <input type="number" name="lockerCount" value="${settings.lockerCount}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="secondary-button" id="resetSettings">重設預設值</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    bindEvents() {
        ...
        form.addEventListener('submit', (e) => {
            ...
            const newSettings = {
                ...
                specialTimeSlot: {
                    start: formData.get('specialStart'),
                    end: formData.get('specialEnd'),
                    discount: parseInt(formData.get('discount'))
                },
                prices: {
                    regular: parseInt(formData.get('regularPrice')),
                    student: parseInt(formData.get('studentPrice')),
                    senior: parseInt(formData.get('seniorPrice'))
                },
                lockerCount: parseInt(formData.get('lockerCount'))
            };
...
// 擴充 SettingsManager 的初始化函數
SettingsManager.initSettingsSection = function() {
    // ...existing code...
    
    // 初始化管理者設定
    window.settingsModule.initAdminSettings();
...
document.addEventListener('DOMContentLoaded', () => {
    // 註冊設定頁面載入處理器
    registerSectionHandler('settings', () => {
        SettingsManager.initSettingsSection();
    });
});
